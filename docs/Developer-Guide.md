...
| JEX Parser | C# | Reused from Khaos.JEX for accurate parsing |
...
```
c:\My\Khaos\
├── Khaos.Jex/                        # Core JEX library
│   ├── src/
│   │   └── Khaos.JEX/                # Parser, runtime, standard library
│   ├── tests/
│   │   └── Khaos.JEX.Tests/
│   ├── benchmarks/
│   │   └── Khaos.JEX.Benchmarks/
│   ├── scripts/                      # build.ps1, test.ps1, pack.ps1, clean.ps1
│   └── docs/
│
├── Khaos.JEX.LanguageServer/         # Language Server (separate project)
│   ├── src/
│   │   └── Khaos.JEX.LanguageServer/ # LSP implementation
│   │       ├── Program.cs            # Entry point
│   │       ├── Handlers/             # Completion, Hover, TextDocSync
│   │       └── Services/             # DocumentManager, etc.
│   ├── tests/
│   │   └── Khaos.JEX.LanguageServer.Tests/
│   └── scripts/                      # build.ps1, test.ps1, clean.ps1
│
├── Khaos.Jex.VSCode/                 # VS Code Extension (separate project)
│   ├── src/
...
- Open `Khaos.JEX.sln` in Visual Studio 2022 or VS Code with C# Dev Kit
- Ensure .NET 10 SDK is selected

**For TypeScript (VS Code Extension)**:
- Open `Khaos.Jex.VSCode` folder in VS Code
...
cd c:\My\Khaos\Khaos.Jex
.\scripts\build.ps1

# Build Language Server
cd c:\My\Khaos\Khaos.JEX.LanguageServer
.\scripts\build.ps1

# Build VS Code Extension (includes Language Server)
cd c:\My\Khaos\Khaos.Jex.VSCode
.\scripts\build.ps1
```
...
```powershell
cd c:\My\Khaos\Khaos.JEX.LanguageServer
dotnet build src/Khaos.JEX.LanguageServer
```
...
```powershell
cd c:\My\Khaos\Khaos.JEX.LanguageServer
dotnet test tests/Khaos.JEX.LanguageServer.Tests
```
...
4. Find `Khaos.JEX.LanguageServer.exe`
...
1. Open `Khaos.Jex.VSCode` folder in VS Code
...
Edit `Khaos.Jex.VSCode/snippets/jex.json`:
...
Edit `Khaos.Jex.VSCode/syntaxes/jex.tmLanguage.json`:
...
2. Update version in `Khaos.JEX.LanguageServer.csproj`
