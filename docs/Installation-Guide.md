...
```json
{
    "$schema": "https://raw.githubusercontent.com/khaos/Khaos.Jex/main/Khaos.Jex.VSCode/schemas/jex.functions.schema.json",
    "functions": [
        {
...
```powershell
code --uninstall-extension khaos.khaos-jex
```
...
```powershell
# Windows
Remove-Item -Recurse "$env:USERPROFILE\.vscode\extensions\khaos.khaos-jex-*"
